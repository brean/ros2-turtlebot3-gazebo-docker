# Contributing to ROS 2 turtlebot 3 gazebo docker
...
The preferred way to contribute to **ROS 2 turtlebot 3 gazebo docker** is to fork the main repository on Gitlab, then submit a "pull request"
(PR):

1. Fork the [project repository](git@github.com:brean/ros2-turtlebot3-gazebo-docker.git):
   click on the 'Fork' button near the top of the page. This creates a copy of
   the code under your account on the Gitlab server.

3. Clone this copy to your local disk:

        $ git clone git@github.com:YourLogin/ros2-turtlebot3-gazebo-docker.git
...
Check the [Issue Tracker](https://github.com/brean/ros2-turtlebot3-gazebo-docker/issues) for roadmap planning. 